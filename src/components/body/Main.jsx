...
const Main = () => {
  return (
    <>
      ...
      <div className="md:w-screen flex flex-col items-center justify-center">
        <section className="flex flex-col md:flex-row m-auto md:w-2/3 lg:w-3/6 items-center  ">
          <div className=" flex w-96 h-72 md:mr-10 items-center  bg-gry p-50">
        ...
        <div className="bg-neutral flex flex-col justify-center w-screen">
          <section className="md:w-2/3 lg:w-3/6 border-4 flex flex-col m-auto  ">
            ...
            <div className="md:flex text-white    mt-5">
              <div className="relative  md:ml-8">
                <Image className=""src={place} alt="Picture of the author" />
                <div className="h-20 flex  w-full items-center absolute bottom-0 md:w-full left-0 rounded-b-2xl  bg-Cta">
                  <span className=" ml-3 ">
              ...
              <div className="relative mt-5 md:mt-0 md:ml-8">
            ...
            <div className="bg-green-600 rounded-xl text-white  mt-7 p-4">
              <h5 className="text-center text-2xl  ">HOW TO GET STARTED </h5>
